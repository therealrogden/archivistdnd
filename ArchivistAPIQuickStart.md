Title: Archivist API &amp; Developer Docs | TTRPG Campaign Management &amp; RAG

URL Source: https://developers.myarchivist.ai/docs

Markdown Content:
---
description: Learn the fundamentals of the Archivist API. Comprehensive guides covering authentication, data models, quests, beats, moments, and common workflows for TTRPG campaign management.
title: Archivist API &amp; Developer Docs | TTRPG Campaign Management &amp; RAG
image: https://developers.myarchivist.ai/og.png
---
...
[Quick StartMake your first request in minutes.](#quick-start)[AuthenticationUse your API key with headers.](#auth)[API ReferenceEndpoints, parameters, and responses.](/api-reference)
...
**Link** — A relationship between two entities (Character, Faction, Location, Item, Beat, etc.) with optional alias/label. Link create/update normalizes aliases and validates that both records exist in the same campaign. Links power Archivist's _wikilinks_ and graph views.
...
```json
{"@context":"https://schema.org","@graph":[{"@type":"Organization","name":"Archivist AI","url":"https://myarchivist.ai/","logo":"https://developers.myarchivist.ai/apple-icon.png"},{"@type":"WebSite","name":"Archivist Developers","url":"https://developers.myarchivist.ai/","potentialAction":{"@type":"SearchAction","target":"https://developers.myarchivist.ai/search?q={search_term_string}","query-input":"required name=search_term_string"}},{"@type":"SoftwareApplication","name":"Archivist API","operatingSystem":"Any","applicationCategory":"DeveloperApplication","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"},"url":"https://developers.myarchivist.ai/api-reference","description":"REST API with streaming for TTRPG campaign management, Beats & Moments modeling, and RAG queries over campaign data."}]}
```
